...
> Quando o Sass é processado, ele leva as variáveis que definiu como ($font-stack e $primary-color) para arquivos CSS com os nossos valores de variáveis colocados no CSS. Isso pode ser extremamente poderoso ao trabalhar com cores e mantê-las consistentes em todo o site.
